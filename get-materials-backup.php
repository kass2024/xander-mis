    ...
    <style>
        * {
        ...
        .file-card:hover {
            ...
            box-shadow: 0 8px 24px rgba(1, 47, 107, 0.12);
        }
...
<main class="main-container">
    ...
    <div class="page-header">
        ...
        <div class="country-indicator" id="currentCountryIndicator">
            <i class="bi bi-geo-alt"></i>
            <span id="currentCountryText">🇷🇼 Rwanda</span>
        </div>
    </div>
...
const currentCountryIndicator = document.getElementById('currentCountryIndicator');
...
countrySelect.addEventListener('change', (e) => {
    ...
    currentCountryText.textContent = `${countryFlag} ${countryName}`;
    
    // Reload files for new country
    loadFiles();
    ...
    showToast(`Switched to ${countryName} materials`, 'info');
});
