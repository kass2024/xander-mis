...
<head>
<meta charset="UTF-8">
<title>Signed Student Contracts (Special)</title>
...
<div class="header xgs-admin-header">
    <h1>Signed Student Contracts <span style="font-size:12px;font-weight:500;color:#64748b;background:#eef2ff;padding:4px 10px;border-radius:999px;margin-left:8px;">Special</span></h1>
