    ...
    $contacts = [
        ...
        'offices' => [
            ...
            [
                ...
                'address_en' => 'Town Center Building (near Simba Supermarket), 2nd Floor, Door: F2B-022C, Nyarugenge',
                'address_fr' => 'Town Center Building (près de Simba Supermarket), 2e étage, Porte : F2B-022C, Nyarugenge',
                ...
                'lat' => -1.9441,
                'lng' => 30.0619,
                'google_maps_link' => 'https://maps.google.com/?q=Town+Center+Building+Simba+Supermarket+Nyarugenge+Kigali+Rwanda',
            ],
        ],
    ];
