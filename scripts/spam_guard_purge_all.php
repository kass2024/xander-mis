<?php
/**
 * Purge bot/spam rows from all public intake tables.
 *
 * CLI:  php scripts/spam_guard_purge_all.php [--dry-run] [--limit=200]
 * Web:  /scripts/spam_guard_purge_all.php?key=YOUR_CRON_SECRET&limit=200
